...
IMAGE_NAME="${INVESTMENT_SSR_IMAGE:-investment-web-frontend}"
IMAGE_TAG="${INVESTMENT_SSR_TAG:-1.0.0}"
IMAGE_REGISTRY="$(resolve_harbor_registry_for_push "${INVESTMENT_SSR_IMAGE_REGISTRY:-harbor.sunmoonai.com}")"
IMAGE_PROJECT="${INVESTMENT_SSR_IMAGE_PROJECT:-app-images}"
